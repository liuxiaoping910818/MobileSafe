...
import liu.com.mobilesafe.activity.EnterPwdActivity;
import liu.com.mobilesafe.dao.AppLockDao;
...
public class WatchDogService extends Service {
    ...
    public void onCreate() {
        ...
        new Thread() {
            public void run() {
                while (isRunning) {
                    ...
                    List<ActivityManager.RunningTaskInfo> runningTasks = mAM.getRunningTasks(1);// 获取当前运行的任务栈,
                    // 返回一条最新的任务栈
        ...
        filter.addAction("liu.com.mobilesafe.SKIP_CHECK");
        registerReceiver(mReceiver, filter);

        // 监听程序锁数据库变化
        mObserver = new MyContentObserver(null);
        getContentResolver().registerContentObserver(
                Uri.parse("content://liu.com.mobilesafe/change"), true,
                mObserver);
    }
