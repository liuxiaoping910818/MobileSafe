...
public class BlacknumberService extends Service {
     ...
     * 3. 找ServiceManager
     * 4. ITelephony.aidl
     * 5. 配置权限  <uses-permission android:name="android.permission.CALL_PHONE" />
     */
    public void endCall() {
    ...
    public void deleteCallDialog(String number){
    ...
    class  MyObserver extends ContentObserver{
        ...
        public void onChange(boolean selfChange) {
            ...
            deleteCallDialog(incomingNumber);
