...
import liu.com.mobilesafe.util.StreamUtils;
...
public class SplashActivity extends Activity {
    ...
    private void copyDb(String dbName){
        ...
        //拷贝前先判断文件是否存在，
        //拿到/data/data/包名/file/目录
        File fileDir=getFilesDir();
        File targetFile=new File(fileDir,dbName);
        ...
        try {
            AssetManager assts= getAssets();
             in=assts.open(dbName);
